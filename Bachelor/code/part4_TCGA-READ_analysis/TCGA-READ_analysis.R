...
# 设定工作目录
setwd("/Users/mymacstudio/GitDB/CPU/Bachelor/data/TCGA/TCGA-READ")
...
point <- colnames(case.mean.expression)[4]
...
# Stage I:19.6024326515285
# Stage II:20.3119345488909
# Stage III:25.5847384787212
# Stage IV:30.0116911091858
