...
###### save
# save case TPM
write.csv(case_TPM,"D:\\Github\\GitDB\\CPU\\Bachelor\\data\\TCGA\\TCGA-READ\\case\\case.csv",
          row.names=TRUE)
# save reference TPM
write.csv(ref_TPM,"D:\\Github\\GitDB\\CPU\\Bachelor\\data\\TCGA\\TCGA-READ\\ref\\ref.csv",
          row.names=TRUE)
...
write.csv(clinical_info,"D:\\Github\\GitDB\\CPU\\Bachelor\\data\\TCGA\\TCGA-READ\\clinical\\clinical_info.csv")

# save PPI network
write.csv(ppi_final[,c("from_symbol","to_symbol","combined_score")],
          "D:\\Github\\GitDB\\CPU\\Bachelor\\data\\TCGA\\TCGA-READ\\PPI.csv",row.names=FALSE)
